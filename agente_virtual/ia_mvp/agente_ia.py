...
11.1 - Quando o usuário disser uma das possíveis formas de pagamento (cartão de crédito, cartão de débito ou dinheiro físico), encerre o atendimento imediatamente com a frase "Voltarei com seu pedido em breve”.
